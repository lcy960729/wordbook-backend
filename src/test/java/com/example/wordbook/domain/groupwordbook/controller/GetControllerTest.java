...
public class GetControllerTest {
    ...
    public void getGroupWordBook() throws Exception {
        //given
        ...
        given(getGroupWordBookService.getDetailDTOById(anyLong())).willReturn(groupWordBook);

        //when
        ResultActions resultActions = requestGetGroupWordBook(0L);
